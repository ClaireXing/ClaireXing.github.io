...
<img src= url('{{ site.baseurl }}\images\blog20101020\framework.png') alt="framework" style="zoom:50%;" />
...
<img src=url('{{ site.baseurl }}\images\blog20101020\mappings.png') alt="mappings" style="zoom:50%;" />
...
<img src=url('{{ site.baseurl }}\images\blog20101020\Grad_CAM.png') alt="Grad_CAM" style="zoom:70%;" />
...
<img src=url('{{ site.baseurl }}\images\blog20101020\neighbor.png') alt="neighbor" style="zoom: 50%;" />
